...
# --- TEMPLATES ---
HTML_TEMPLATE = """..."""   # paste your full HTML_TEMPLATE here
LOGIN_TEMPLATE = """..."""  # paste your LOGIN_TEMPLATE here
SIGNUP_TEMPLATE = """...""" # paste your SIGNUP_TEMPLATE here
PROFILE_TEMPLATE = """..."""# paste your PROFILE_TEMPLATE here

# --- HELPERS & ROUTES (unchanged) ---
...
# --- DB SEED function (call manually) ---
def seed_database():
...
if __name__ == '__main__':
    # Local dev only: create DB and seed
